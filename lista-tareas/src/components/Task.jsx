...
Task.propTypes = {
    item: PropTypes.shape({
      ...
      important: PropTypes.bool.isRequired, // Indica si la tarea es importante
      date: PropTypes.string.isRequired, // fecha tarea "
    }).isRequired,
    onToggleComplete: PropTypes.func.isRequired, // cambiar estado a completado
    onToggleImportant: PropTypes.func.isRequired, // cambiar estado a importante
    onDeleteTask: PropTypes.func.isRequired, // fn eliminar la tarea
    filter: PropTypes.string.isRequired, // filtro actual
    onOpenModal: PropTypes.func.isRequired, // fn abrir el modal
    setId: PropTypes.func.isRequired, // fn el id de la tarea
};
